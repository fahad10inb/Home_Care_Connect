...
const ProviderDashboard = () => {
    ...
    const [previousBookings, setPreviousBookings] = useState([
        { name: 'Alice', rating: 5, date: '2024-09-01', time: '1:00 PM', location: '123 Oak St' },
        { name: 'Bob', rating: 4, date: '2024-09-10', time: '11:00 AM', location: '321 Pine St' },
    ]);
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
                    {jobs.map((job) => (
                        <div key={job.id} className="bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
                            ...
                            <div className="flex justify-between mt-4 gap-4"> {/* Added gap between buttons */}
                                <button className="bg-[#7978E9] text-white rounded px-4 py-2 hover:bg-[#4B49AC] transition duration-300">Accept</button>
                                <button className="bg-[#F3797E] text-white rounded px-4 py-2 hover:bg-[#F3A4A4] transition duration-300">Decline</button>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                {showModal && (
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                        <div className="bg-white p-5 rounded shadow-lg w-11/12 md:w-1/2">
                            ...
                            <button
                                className="mt-4 bg-[#F3797E] text-white rounded px-4 py-2 hover:bg-[#F3A4A4] transition duration-300"
